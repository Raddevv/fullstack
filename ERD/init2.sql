...
CREATE TABLE IF NOT EXISTS `mydb`.`product_has_locaties` (
  ...
  `product_bestelling_id` INT NOT NULL AUTO_INCREMENT,
  `locaties_id` INT NOT NULL AUTO_INCREMENT,
  `locaties_voorraad_id` INT NOT NULL AUTO_INCREMENT,
  `aantal` VARCHAR(100000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`bestelling_has_factuur` (
  `bestelling_id` INT NOT NULL AUTO_INCREMENT,
  `bestelling_medewerker_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`voorraad_has_product` (
  `voorraad_id` INT NOT NULL AUTO_INCREMENT,
  `product_id` INT NOT NULL AUTO_INCREMENT,
  `product_bestelling_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`product_has_bestelling` (
  ...
  `product_bestelling_id` INT NOT NULL AUTO_INCREMENT,
  `bestelling_id` INT NOT NULL AUTO_INCREMENT,
  `bestelling_klant_id` INT NOT NULL AUTO_INCREMENT,
  `bestelling_medewerker_id` INT NOT NULL AUTO_INCREMENT,
